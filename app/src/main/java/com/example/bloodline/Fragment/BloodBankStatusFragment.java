...
import com.example.bloodline.Adapter.BloodBankAdapter;
...
public class BloodBankStatusFragment extends Fragment
{
    ...
    {
        return inflater.inflate(R.layout.bankrecyclerviewlayout,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
       ...
       */
        ...
        BloodBankAdapter bloodBankAdapter = new BloodBankAdapter(banklist,ctx);
        rv_bloodbank.setLayoutManager(new LinearLayoutManager(ctx, LinearLayout.VERTICAL,false));
        rv_bloodbank.setAdapter(bloodBankAdapter);
